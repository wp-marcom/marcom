...
for(n=0;n<curJobList.length;n++){
  ws_data.push([`Becky`,`Wigginton-Colon`,`West Press`,`1663 W Grant Rd`,`Tucson`,`AZ`,`85745-1433`,`${curJobList[n]}`],[`Sam`,`Veltman`,`Acquire Direct Marketing`,`12620 Race Track Road`,`Tampa`,`FL`,`33626`,`${curJobList[n]}`])
}
