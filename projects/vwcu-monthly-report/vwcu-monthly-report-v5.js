...
function buildRow(row, columns) {
  return columns.map(colSpec => {
    const raw = getCellText(row.getCell(colSpec.source));
    return colSpec.transform ? colSpec.transform(raw) : raw;
  });
}
