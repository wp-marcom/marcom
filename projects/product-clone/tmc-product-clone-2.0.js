...
const productGroups = [
  {
    mother: 'BRUN-1107 - TMCHCC Colorectal: Anal Fissures Info Brochure',
    children: ['BRUN-1108 - TMCHCC Colorectal: Condyloma Info Brochure', 'BRUN-1109 - TMCHCC Colorectal: Lavator Syndrome Info Brochure', 'BRUN-1110 - TMCHCC Colorectal: Pruritus Info Brochure', 'BRUN-1112 - TMCHCC Colorectal: Anal Fistula Info Brochure', 'BRUN-1113 - TMCHCC Colorectal: Constipation Info Brochure']
  }
];

// Client Portal Configuration
const clientPortal = 'TMC';
const clientPortalId = '23660'; // Mister portal ID
