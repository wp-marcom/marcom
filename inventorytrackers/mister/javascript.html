...
// AND PASSES RETURNED DATA TO THE showData() FUNCTION
google.script.run.withSuccessHandler(showData).getData();

// Modified showData() function to apply styling based on status values and convert SKU values to clickable links
